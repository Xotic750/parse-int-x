 ...
 * @module parse-int-x
 */
"use strict";var $parseInt,nativeParseInt=parseInt,ws=_dereq_("white-space-x").string;$parseInt=8===nativeParseInt(ws+"08")&&22===nativeParseInt(ws+"0x16")?nativeParseInt:function(){var trim=_dereq_("trim-x"),toStr=_dereq_("to-string-x"),castNumber=_dereq_("cached-constructors-x").Number,hexRegex=/^[-+]?0[xX]/,test=hexRegex.test;return function parseInt(string,radix){var str=trim(toStr(string));return nativeParseInt(str,castNumber(radix)||(test.call(hexRegex,str)?16:10))}}(),module.exports=$parseInt},{"cached-constructors-x":2,"to-string-x":8,"trim-x":11,"white-space-x":13}],2:[function(_dereq_,module,exports){/**
