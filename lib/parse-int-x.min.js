 ...
 * @module parse-int-x
 */
"use strict";var $parseInt,nativeParseInt=parseInt,ws=_dereq_("white-space-x").string,toStr=_dereq_("to-string-x");$parseInt=8===nativeParseInt(ws+"08")&&22===nativeParseInt(ws+"0x16")?_dereq_("has-symbol-support-x")?_dereq_("attempt-x")(nativeParseInt,Symbol("")).threw?nativeParseInt:function parseInt(string,radix){return nativeParseInt(toStr(string),radix)}:nativeParseInt:function(){var trim=_dereq_("trim-x"),castNumber=_dereq_("cached-constructors-x").Number,hexRegex=/^[-+]?0[xX]/,test=hexRegex.test;return function parseInt(string,radix){var str=trim(toStr(string));return nativeParseInt(str,castNumber(radix)||(test.call(hexRegex,str)?16:10))}}(),module.exports=$parseInt},{"attempt-x":2,"cached-constructors-x":3,"has-symbol-support-x":4,"to-string-x":10,"trim-x":13,"white-space-x":15}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x"),toStr=_dereq_("to-string-x");module.exports=function requireCoercibleToString(value){return toStr(requireObjectCoercible(value))}},{"require-object-coercible-x":9,"to-string-x":10}],9:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":5}],10:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var castString="".constructor,isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return castString(value)}},{"is-symbol":6}],11:[function(_dereq_,module,exports){/**
